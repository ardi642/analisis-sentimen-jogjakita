...
SLANG_DATA = {
    ...
    "kwalitas": "kualitas",
    "yogja kita": "jogjakita",
    "yogja": "jogja",
    "yogjakarta": "yogyakarta",
    "rekom": "rekomendasi",
    "kntl": "kontol",
    "anjg": "anjing",
    "promonyang": "promo yang",
    "pokoke": "pokoknya",
    "pkke": "pakai",
    "lodingnya": "loadingnya",
    "nyebai": "sebal",
    "lebihhhhhh": "lebih",
    "binggung": "bingung",
    "okee": "oke",
    ...
    "kagak": "tidak",
    "kaga": "tidak",
    "lovejogjakita": "cinta jogjakita",
    "mapmya": "mapnya",
    "saing": "bersaing",
    "it": "itu",
    "mantabs": "mantap",
    "topjogjanya": "mantap jogjanya",
    "mendadakk": "mendadak",
    "lanjuuuut": "lanjut",
    "top": "mantap",
    "sip": "ok",
    ...
    "opo": "apa",
    "iki": "ini",
    "ongkiry": "ongkos kirim",
    "spay": "shopee",
    "spay later": "shopee paylater",
    "shope": "shopee",
    "tak": "tidak",
    "lu": "kamu",
    "bangak": "banyak",
    ...
    "menju": "menuju",
    "pelang": "pelanggan",
    "mengangur": "menganggur",
    "penganguran": "pengangguran",
    "aplksinya": "aplikasinya",
    "pelangan": "pelanggan",
    "langanan": "langganan",
    "tersersebut": "tersebut",
    "no telp": "nomor telepon",
    "no hp": "nomor telepon",
    "menyenyangkan": "menyenangkan",
    "tingal": "tinggal",
    "blank": "kosong",
    "sat": "saat",
    "itubaruistimewa": "itu baru istimewa",
    "bayr": "bayar",
    "standarin": "standar",
    "ditangguhkan": "dihentikan",
    "brkali": "berkali",
    "perhati": "simak",
    "konfirm": "konfirmasi",
    "anter": "antar",
    ...
    "thre": "three",
    "the best": "terbaik",
    "pertahanankan": "pertahankan",
    "pertanggungjawabannya": "pertanggung jawabannya",
    "refferal": "referal",
    "prefer": "lebih suka",
    "jogjafod": "jogjafood",
    "diminati": "minat",
    ...
    "smart": "pintar",
    "biyaya": "biaya",
    "washting time": "buang waktu",
    "zom": "zoom",
    "mrh": "murah",
    "hrgny": "harganya",
    "benerin": "perbaiki",
    "kepake": "dipakai",
    "lokaltakgentar": "lokal tidak gentar",
    "laper": "lapar",
    "via": "lewat",
    "ngegoride": "jogjaride",
    "malu in": "memalukan",
    "maluin": "memalukan",
    "nyaingin": "menyaingi",
    "maksimalin": "maksimalkan",
    "pemprosesan": "pemrosesan",
    "deg deg": "berdebar debar",
    ...
    "median": "media",
    "ijonya": "ijo nya",
    "aplkasinya": "aplikasinya",
    "tangapanya": "tanggapannya",
    "bertnya": "bertanya",
    "penguna": "pengguna",
    "taun": "tahun",
    "service": "layanan",
    ...
    "engak": "tidak",
    "tgihanya": "tagihannya",
    "tgihannya": "tagihannya",
    "layan": "layanan",
    "pelayananya": "layanannya",
    "nganterinya": "mengantarkannya",
    "gangu": "ganggu",
    "mengangu": "mengganggu",
    "oke": "ok",
    "rojol": "ojol",
    ...
    "depositttt": "deposit",
    "suah": "sudah",
    "jogja ride": "jogjaride",
    "jogja kurir": "jogjakurir",
    "jogja food": "jogjafood",
    "jogja shop": "jogjashop",
    "jogja car": "jogjacar",
    "jogja send": "jogjasend",
    "mintak": "minta",
    "notif": "notifikasi",
    "isa": "bisa",
    "simple": "simpel",
    "yogjakarta": "yogyakarta",
    "kebangeten": "kebangetan",
    "dihape": "di hp",
    "filed": "gagal",
    "cencel": "batal",
    "penjemputanya": "penjemputannya",
    "custumer": "customer",
    "rubh": "rubah",
    "nyoba": "mencoba",
    "terbaiki": "terbaik",
    "mayasarakat": "masyarakat",
    "iklanya": "iklannya",
    "tinhkagakan": "tingkatkan",
    "memesan": "pesan",
    "samasekali": "sama sekali",
    "benget": "banget",
    "jogjankita": "jogjakita",
    "henat": "hemat",
    "veroff": "verifikasi  offline",
    "pangilan": "panggilan",
    "only": "hanya",
    "search": "cari",
    "ngisi": "mengisi",
    "downloat": "download",
    "vertikasi": "verifikasi",
    "pecerahanya": "pencerahannya",
    "costomer": "customer",
    "aplikasih": "aplikasi",
    "nyasar": "tersesat",
    "kecele": "kesal",
    ...
    "olshopper": "pembeli online",
    "olshoper": "pembeli online",
    "komplein": "komplain",
    "dikomplein": "dikomplain",
    "lemotttt": "lemot",
    "mengasih": "beri",
    "ngadih": "beri",
    "kususnya": "khususnya",
    "lrbih": "lebih",
    "jokja": "jogja",
    "menyejaterakan": "mensejahterakan",
    "mntep": "mantap",
    "mntepp": "mantap",
    "ntap": "mantap",
    "ditelp": "ditelpon",
    ...
    "matab": "mantap",
    "membatu": "membantu",
    "dierpanjang": "diperpanjang",
    "mantaaaf": "mantap",
    "mantaf": "mantap",
    "manstap": "mantap",
    "bukak": "buka",
    "jogyakita": "jogjakita",
    "jogya kita": "jogjakita",
    "telpon": "telepon",
    "tlfon": "telepon",
    "maksutnya": "maksudnya",
    "log out": "logout",
    "penjeputan": "penjemputan",
    "syinyal": "sinyal",
    "pgantran": "pengantaran",
    "prbaruhi": "perbarui",
    "confirm": "konfirmasi",
    "deposit": "isi ulang",
    "depo": "isi ulang",
    ...
    "mengcancel": "membatalkan",
    "pengcancelnya": "pembatalnya",
    "mutar": "putar",
    "muter": "memutar",
    "transpotasi": "transportasi",
    "unt": "untuk",
    "speed cash": "speedcash",
    "lelet": "lambat",
    ...
    "ngirit": "irit",
    "monggo": "mari",
    "kumenangis": "ku menangis",
    "mengheran": "mengherankan",
    "diaplikasi": "di aplikasi",
    "jogya": "jogja",
    "amat": "sangat",
    "yogyakita": "jogjakita",
    "yogya kita": "jogjakita",
    "akir": "akhir",
    "gara": "karena",
    "malesin": "malas",
    "klick": "tekan",
    ...
    "sagat": "sangat",
    "apliksi": "aplikasi",
    "apliksinya": "aplikasinya",
    "sekitarnnya": "sekitarnya",
    "ngojek": "ojek",
    "jogja kita": "jogjakita",
    "jogkit": "jogjakita",
    "campaign": "kampanye",
    "e-moneynya": "uang digitalnya",
    "ngundang": "mengundang",
    "onlaine": "online",
    "uniinstal": "uninstall",
    "apus": "hapus",
    "campain": "kampanye",
    "regristrasi": "registrasi",
    "nyusahin": "menyusahkan",
    "nyari": "mencari",
    "mndg": "lebih baik",
    "strayegi": "strategi",
    "memberdaykn": "memberdayakan",
    "trimakasih": "terima kasih",
    "pglaman": "pengalaman",
    "ngeribetin": "merumitkan",
    "ngeklik": "tekan",
    "gagara": "karena",
    "csnya": "customer servicenya",
    "kesel": "kesal",
    "dmintain": "dimintain",
    "applikasinya": "aplikasinya",
    "non": "tidak",
    "respond": "respon",
    "slow": "lambat",
    "zonk": "tidak ada",
    ...
    "kususs": "khusus",
    "skses": "sukses",
    "e-voucher": "voucher digital",
    "evocher": "voucher digital",
    "evoucher": "voucher digital",
    "inih": "ini",
    "syulit": "sulit",
    "trsebut": "tersebut",
    "trsebutlah": "tersebutlah",
    "penipun": "penipuan",
    "jelasin": "jelaskan",
    "padahl": "padahal",
    "bernda": "beranda",
    ...
    "ngebug": "error",
    "triver": "driver",
    "t&c": "syarat dan ketentuan",
    "seeikitnya": "sedikitnya",
    "seeikit": "sedikit",
    "ksanya": "kesannya",
    "mksa": "maksa",
    "wa": "whatsapp",
    ...
    "dmana": "dimana",
    "dilnoat": "download",
    "lollaaaa": "loading lama",
    "byeee": "bye",
    "ngehargai": "menghargai",
    "pesananya": "pesanannya",
    "lola": "loading lama",
    "disiniii": "disini",
    "astribut": "atribut",
    "cobaa": "coba",
    ...
    "kt": "kita",
    "amiiiiiiiiiinnnnnnn": "aamiin",
    "nolongin": "menolong",
    "amiiiiiiiiiiin": "aamiin",
    "seluru": "seluruh",
    "amiennn": "amien",
    "tebir": "ribet",
    "doangam": "doang",
